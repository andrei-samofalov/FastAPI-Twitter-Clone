...
//! moment.js locale configuration
        ...
        "use strict";
        a("b0c0");
        var n = a("7a23"), s = {class: "tweet"}, r = {class: "tweet-owner"},
            i = ["src"], d = {class: "tweet-content"},
            _ = {class: "tweet-content-header"},
            o = Object(n["h"])("span", null, "·", -1),
            u = {class: "created-at"}, m = {class: "tweet-content-body"},
            l = {key: 0}, c = {key: 1, class: "tweet-content-edit-tweet"},
            h = {key: 2, class: "tweet-content-body-images"},
            M = {class: "tweet-content-body-images-wrapper"}, L = ["src"],
        ...
        function k(e, t, a, k, D, w) {
            var g, T, v, b, S, H, j, x, O = Object(n["C"])("router-link"),
                P = Object(n["C"])("base-icon"), W = Object(n["C"])("BaseIcon"),
        ...
        var D = a("1da1"), w = a("5530"), g = (a("96cf"), a("4de4"), a("8bac")),
            T = {class: "edit-tweet-popup"}, v = {class: "icon"},
        ...
        var A = new W["AvatarGenerator"], F = {
            ...
            computed: Object(w["a"])(Object(w["a"])({}, Object(E["b"])({me: "getMe"})), {}, {
                tweetImages: function () {
                    ...
                    var e,
                        t = P.a.utc(null === (e = this.tweetData) || void 0 === e ? void 0 : e.stamp).format();
                    return P()(t).fromNow()
...
//! momentjs.com
            (function (t, a) {
                ...
                var Ye, ye = /\d/, pe = /\d\d/, ke = /\d{3}/, De = /\d{4}/,
                    we = /[+-]?\d{6}/, ge = /\d\d?/, Te = /\d\d\d\d?/,
                    ve = /\d\d\d\d\d\d?/, be = /\d{1,3}/, Se = /\d{1,4}/,
                    He = /[+-]?\d{1,6}/, je = /\d+/, xe = /[+-]?\d+/,
                    Oe = /Z|[+-]\d\d:?\d\d/gi, Pe = /Z|[+-]\d\d(?::?\d\d)?/gi,
                    We = /[+-]?\d+(\.\d{1,3})?/,
                ...
                var Ue, Ge = 0, Ve = 1, Be = 2, $e = 3, Ke = 4, qe = 5, Ze = 6,
                    Qe = 7, Xe = 8;
                ...
                var Et = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
                    ...
                    Ft = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), zt = Ee, Nt = Ee,
                    Jt = Ee;
                ...
                function Ra(e) {
                    if (e._f !== r.ISO_8601) if (e._f !== r.RFC_2822) {
                        e._a = [], Y(e).empty = !0;
                        var t, a, n, s, i, d, _ = "" + e._i, o = _.length,
                            u = 0;
                ...
                function dn(e) {
                    var t = ie(e), a = t.year || 0, n = t.quarter || 0,
                        s = t.month || 0, r = t.week || t.isoWeek || 0,
                        i = t.day || 0, d = t.hour || 0, _ = t.minute || 0,
                        o = t.second || 0, u = t.millisecond || 0;
                ...
                function un(e, t, a) {
                    var n, s = Math.min(e.length, t.length),
                        r = Math.abs(e.length - t.length), i = 0;
                ...
                function In(e, t) {
                    ...
                    var a = e || Ka(), n = hn(a, this).startOf("day"),
                ...
                function Sr() {
                    var e, t, a, n, s, r = this._milliseconds, i = this._days,
                        d = this._months, _ = this._data;
                ...
                var Wr = Pr("ms"), Er = Pr("s"), Ar = Pr("m"), Fr = Pr("h"),
                    zr = Pr("d"), Nr = Pr("w"), Jr = Pr("M"), Rr = Pr("Q"),
                    Cr = Pr("y");
                ...
                var Vr = Gr("milliseconds"), Br = Gr("seconds"),
                    $r = Gr("minutes"), Kr = Gr("hours"), qr = Gr("days"),
                ...
                function ni(e, t, a, n) {
                    var s = Hn(e).abs(), r = ei(s.as("s")), i = ei(s.as("m")),
                        d = ei(s.as("h")), _ = ei(s.as("d")), o = ei(s.as("M")),
                        u = ei(s.as("w")), m = ei(s.as("y")),
                ...
                function oi() {
                    if (!this.isValid()) return this.localeData().invalidDate();
                    var e, t, a, n, s, r, i, d,
                        _ = di(this._milliseconds) / 1e3, o = di(this._days),
...
//! moment.js locale configuration
            ...
            function r(e) {
                var a = Math.floor(e % 1e3 / 100), n = Math.floor(e % 100 / 10),
                    s = e % 10, r = "";
